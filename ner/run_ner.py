...
def main(model_args, data_args, training_args):
    ...
    if config.model_type in {"bloom", "gpt2", "roberta", "longformer", "nystromformer"}:
    ...
    # Metrics
    metric = evaluate.load("heliumind/seqeval")
    ...
    def compute_metrics(p):
        ...
        results = metric.compute(predictions=true_predictions, references=true_labels, mode="strict", scheme="IOB2")
