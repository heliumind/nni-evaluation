...
models = {
    ...
    "christbert_scratch_best": "/home/data/models/ChristBERT/hf/model/scratch/best",
    "christbert_scratch_last": "/home/data/models/ChristBERT/hf/model/scratch/last",
    "christbert_scratch_bpe_best": "/home/data/models/ChristBERT/hf/model/scratch_bpe/best",
    "christbert_scratch_bpe_last": "/home/data/models/ChristBERT/hf/model/scratch_bpe/last",
...
for model_name, model_path in models.items():
    for dataset_name, dataset_path in datasets.items():
        ...
        hpset = {
            ...
            "max_seq_length": {"_type": "choice", "_value": [max_seq_length]},
...
trialCommand: python run_ner.py
trialCodeDirectory: ../../../
trialGpuNumber: 1
